...
class AuthorListViewTest(TestCase):
    ...
    def test_view_uses_correct_template(self):
        ...
        self.assertTemplateUsed(resp, 'authors/authors_list_page.html')
    ...
    def test_lists_all_authors(self):
        ...
        resp = self.client.get(reverse('authors_list')+'?page=2')
        self.assertEqual(resp.status_code, 200)
        self.assertTrue('is_paginated' in resp.context)
        self.assertTrue(resp.context['is_paginated'] == True)
...
class LoanedBookInstancesByUserListViewTest(TestCase):
    ...
    def setUp(self):
        ...
        test_language = Language.objects.create(full_name='English')
    ...
    def test_redirect_if_not_logged_in(self):
        ...
        self.assertRedirects(resp, '/account/login/?next=/catalog/mybooks/')
...
class RenewBookInstancesViewTest(TestCase):
    ...
    def test_form_invalid_renewal_date_past(self):
        ...
        self.assertEqual(resp.status_code,200)
        self.assertTrue('form' in resp.context)  # Ensure form is in context
